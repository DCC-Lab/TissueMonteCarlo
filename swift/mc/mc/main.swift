...
typealias Matrix = SCNMatrix3
typealias Photon = GenericPhoton<Scalar, Vector, Matrix>
...
let N = 100000
let start = Date()
let material = BulkHenyeyGreenstein<Scalar, Vector, Matrix>(mu_s: 30, mu_a: 0.5, index: 1.4, g: 0.8)
